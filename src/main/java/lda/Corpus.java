...
public class Corpus {
	...
	public int[] addDocument(List<String> wordList) {
		int[] doc = new int[wordList.size()];
		int i = 0;
		for (String word : wordList) {
//			System.out.println(vocabulary.getId(word, true));
...
//		System.out.println("============");
	 ...
	 * @throws IOException
	 */
	public static Corpus load(String folderPath,String ecoding) throws IOException {
		Corpus corpus = new Corpus();
		File folder = new File(folderPath);
		for (File file : folder.listFiles()) {
			BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream(file),ecoding));
			String line;
